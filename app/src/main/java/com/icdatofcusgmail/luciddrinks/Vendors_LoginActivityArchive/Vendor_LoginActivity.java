package com.icdatofcusgmail.luciddrinks.Vendors_LoginActivityArchive;
...
public class Vendor_LoginActivity extends AppCompatActivity {
    ...
    String IDCrossCheck_url = "http://128.0.1.2/my_vendor_login.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ConfirmID.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else if (MyIdNo.getText().toString().equals("07")) {
                    myIDWitness.setVisibility(View.VISIBLE);
                    myIDWitness.setText("" + "Sharon Akintobi" + "");
                    myIDWitness.setTextColor(Color.LTGRAY);
                    myIDWitness.setTextSize(80);
                    IDInvisible.setText("7");
                    IDInvisible.setVisibility(View.INVISIBLE);
                    app.sellerOruko = new Bundle();
                    app.sellerOruko.putString("seller_name", "Sharon Akintobi");
                    app.sellerOruko.putString("seller_id", "7");
                }
                else {
