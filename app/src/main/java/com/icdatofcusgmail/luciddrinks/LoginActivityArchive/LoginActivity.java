package com.icdatofcusgmail.luciddrinks.LoginActivityArchive;
...
public class LoginActivity extends AppCompatActivity {
    ...
    String birthday, daymonth, birthdayText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actuallyTime.setOnClickListener(v -> new ShakeAnimation(actuallyTime).animate());
...
//        actuallyTime.setText(strrrinng);
        ...
        String orjor = year + " - " + month + " - " + day;


        //Useful for Lqndmqrk Events
        // daymonth = month + " - " + day;

        actuallyTime.setText(orjor);
        ...
        clearAllUsername.setOnClickListener(v -> {
            UsernameField.getText().clear();
        });

        clearAllPin.setOnClickListener(v ->
    ...
    public void AccessifCorrect(View view) {
        ...
        if (UsernameField.getText().toString().equals("victor.brown") && PasswordField.getText().toString().equals("victorious")) {

            LucidApplication app = LucidApplication.getInstance();
            app.prev.clear();
            app.allindrinkcounter = 0;
            ...
            VeriefiedKorQ.setBackgroundColor(Color.parseColor("#455A64"));
            VeriefiedKorQ.setTextColor(Color.WHITE);
            VeriefiedKorQ.show();

            Intent serverTent = new Intent(LoginActivity.this, DrinksmenuActivity.class);
            Bundle ICDAT = new Bundle();
            ICDAT.putString("name", "Victor Brown");
            ICDAT.putString("email", "victor.brown@lmu.edu.ng");
            ICDAT.putString("accountbalance", "32250");
            ICDAT.putString("sex", "male");
            ICDAT.putString("department", "Economics");
            ICDAT.putString("level", "300");
            ICDAT.putString("d_n_m", "13-02");
            ICDAT.putString("image", "image");
            ICDAT.putString("last_seen_accept", "Monday, 14,May,2018");
            ICDAT.putString("king", "victor.brown");
            ICDAT.putString("kingDavid", "Brown");
            ...
            EmptyFields.setBackgroundColor(Color.parseColor("#455A64"));
            ...
            EmptyField.setBackgroundColor(Color.parseColor("#455A64"));
                            ...
                            try {
                                ...
                                switch (code) {
                                    ...
                                    default:
                                        ...
                                        //  birthday = jsonObject.getString("d_o_b");
                                        //   birthdayText = jsonObject.getString("birthday_recog");
    ...
    protected void onStart() {
        ...
        super.onStart();
        this.intRandom = new Random().nextInt(345);
        if (actuallyTime.getText().toString().contentEquals("2018 - 1 - 29"))
        ...
        else if (actuallyTime.getText().toString().contentEquals("2018 - 2 - 5"))
            this.textRandom.setText("" + "Happy Great Day Dweezy" + "");

            // Not fully Understood
//        else if (birthday.contains(daymonth))
//            this.textRandom.setText(birthdayText);
        else
